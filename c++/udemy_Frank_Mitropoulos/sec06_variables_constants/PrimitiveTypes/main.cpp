...
int main()
{
     ...
     **************************************/
     ...
     cout << "There were " << countries_represented << " countries represented n my meeting" << endl;
     ...
     cout << "The distance to alpha centuari is " << distance_to_alpha_centuari << " kilometers" << endl;
