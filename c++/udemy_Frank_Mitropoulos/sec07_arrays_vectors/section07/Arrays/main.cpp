...
int main()
{
    ...
    cout << "The firt high temperature now is: " << hi_temps[0] << endl;
    
    // int test_scores[5] {}; // all 5 values initialized to 0
   // int test_scores[5] {100}; // only put 100 in the first element
